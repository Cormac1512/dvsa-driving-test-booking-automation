...
const DVSAAutomation = (function () {
    ...
    const app = {
        ...
        handlePage() {
            if (!app.routes) {
                app.routes = [
                    // Optimization: Check results first as this is the most frequent state (polling loop).
                    // This avoids unnecessary DOM queries for previous steps on every reload.
                    {
